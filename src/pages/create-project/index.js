...
function CreateProject() {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#121212', height: '80vh' }}>
            <Card className="mt-3 mb-5" style={{ width: '70%', backgroundColor: '#2C2C2C', color: '#EAEAEA' }}>
                ...
                <Card.Body>
                    <form onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" style={{ backgroundColor: '#424242', color: '#EAEAEA', borderColor: '#626262' }} name="name" value={formData.name} onChange={handleChange} />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" style={{ backgroundColor: '#424242', color: '#EAEAEA', borderColor: '#626262', textAlign: 'left' }} name="type" value={formData.type} onChange={handleChange}>
                        ...
                        <div className="form-group">
                            <label style={{ fontWeight: 'bold', textAlign: 'left', color: '#EAEAEA', display: 'block' }}>Course Number (Optional)</label>
                            <input type="text" className="form-control" style={{ backgroundColor: '#424242', color: '#EAEAEA', borderColor: '#626262' }} name="classNumber" value={formData.classNumber} onChange={handleChange} />
                        </div>
                        </form>
                </Card.Body>
